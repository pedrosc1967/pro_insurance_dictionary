    ...
    stages {
            stage ('Checkout') {
                steps {
                    ...
                    sh "git clone https://github.com/pedrosc1967/pro_insurance_dictionary.git"
                    sh "cp /Users/aplanetbit/StudioProjects/pro_insurance_dictionary/android/key.properties /Users/aplanetbit/.jenkins/workspace/'Dictionary of Insurance Pro'/pro_insurance_dictionary/android/key.properties"
